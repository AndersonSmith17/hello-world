# Feb 14th surprise
# Modified from code originally developed by Summit Consulting LLC
# https://www.summitllc.us/blog/show-your-valentine-how-much-you-care-create-a-statistical-graph
...
# create a data frame with one row per x
